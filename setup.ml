...
(* OASIS_START *)
(* DO NOT EDIT (digest: 00541ab2be9d9727f941038bb082169e) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/seliopou/ocaml-d3";
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build example programs";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "d3"; FindlibPackage ("tyxml", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {
                      lib_modules = ["D3_tyxml"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "d3";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "todo.ml"});
               Executable
                 ({
                     cs_name = "tyxml";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_path = "examples";
                      bs_compiled_object = Byte;
                      bs_build_depends = [InternalLibrary "d3_tyxml"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "tyxml.ml"});
               SrcRepo
                 ({
                     cs_name = "master";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/inhabitedtype/ocaml-d3.git";
                      src_repo_browser =
                        Some "https://github.com/inhabitedtype/ocaml-d3";
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\004\207\167\244\142\152\208\239t\214\023\152\017\231P\004";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
