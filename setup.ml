...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8bca91fd34c86257f8d7c0e68ed73acb) *)
(*
...
let setup_t =
  {
                 ...
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "d3";
                           FindlibPackage ("js_of_ocaml.tyxml", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "V\011\176v\205j9\183\211`t\14986\015q";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
